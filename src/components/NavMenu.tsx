        ...
        <div className="flex justify-between flex-grow mt-12 mx-[15%] max-sm:mx-[5%] items-center">
          <div className="flex flex-grow flex-row max-sm:flex-col-reverse items-start justify-between w-full">
            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  ...
                  {
                    name: "LeetCode",
                    link: "https://leetcode.com/u/Satwinder04/",
                  },
                  {
                    name: "UIverse",
            ...
            >
              ...
              <ul className="space-y-2">
                {[
                  { name: "About Me", id: "about", isGallery: false },
                  { name: "Projects", id: "projects", isGallery: false },
                  { name: "Gallery", id: "gallery", isGallery: true },
                  { name: "Contact", id: "contact", isGallery: false },
                ].map((item, index) => (
                  <motion.li
                    key={item.name}
                    initial={{ x: 20, opacity: 0 }}
                  ...
                  >
                    <a
                      href={item.isGallery ? "/gallery" : `#${item.id}`}
                      onClick={(e) => handleNavClick(e, item.id, item.isGallery)}
