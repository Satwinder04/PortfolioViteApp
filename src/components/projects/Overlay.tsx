...
export default function Overlay({
  ...
  return (
    ...
    >
      <div
        style={{ marginTop: !isMobile ? "15vh" : "2.5rem" }}
        className="max-w-[1000px] w-full"
      >
        <div
          className={`flex flex-row items-center ${!isMobile ? "justify-between" : "justify-start gap-x-2"} w-full mb-[4vh] `}
        >
        ...
        <div className="flex flex-col">
          ...
          <img
            className={`w-full object-cover object-top  select-none ${!project.title.includes("TCG") && "mb-12"}`}
            style={{
              border: "2px solid rgba(255, 255, 255, 0.607)",
              // filter: "grayscale(2) contrast(1.4) brightness(0.4)"
              height: "400px",
            }}
